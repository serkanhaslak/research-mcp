...
/** Token budget for deep research, scraping, and Reddit LLM extraction */
export const TOKEN_BUDGET = 32_000 as const;

/** Calculate token allocation for batch operations */
export function calculateTokenAllocation(count: number, budget: number = TOKEN_BUDGET): number {
