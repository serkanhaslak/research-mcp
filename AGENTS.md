...
- **OAuth tokens require volume** — on Railway, `/data` must be a persistent volume. Without it, tokens are lost on every deploy/restart and Codex must re-authorize.
